Question: 
Hello. I just transfer my laravel project from one folder to another. But my images does not showing. I try php artisan storage:link but it says link already exists. 
...
Question: 
C:\Xamp\htdocs\Laravel Office Work\Ark-Power>rm public/storage
